...
// and apps/corporate-cms-service/prisma/schema.prisma), and with the same
// list mirrored in admin-web's legalDocumentConstants.js. No shared package
// exists across these repos, so this file is civic-web's copy — the backend
// is the source of truth. Fetching an unknown key gets a clean 400 from the
// API, not a silent miss.
