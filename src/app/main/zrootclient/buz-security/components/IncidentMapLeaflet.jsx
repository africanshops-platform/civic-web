              ...
              <Popup maxWidth={280} minWidth={220}>
                <div style={{ fontFamily: 'inherit', padding: '4px 0' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                    ...
                    <span style={{ backgroundColor: statusInfo.bg, color: statusInfo.color, fontWeight: 700, fontSize: '0.72rem', padding: '2px 10px', borderRadius: 999 }}>
                      {statusInfo.label}
                    </span>
                  </div>
...
export default memo(IncidentMapLeaflet);
